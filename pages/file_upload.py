...
def layout():
    """File upload page layout - shows existing dual uploader FIRST"""
    return html.Div([
        # Page header
        html.Div([
        ...
        # EXISTING dual upload interface (this shows FIRST)
        ...
        # EXISTING Column mapping modal (MUST start hidden)
        html.Div([
            html.Div([
                html.Div([
                    # Modal header
