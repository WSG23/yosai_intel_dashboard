...
@app.callback(
    [
        ...
        Output("modal-ai-status", "children"),
        ...
        Output("ai-timestamp-suggestion", "children"),
        Output("ai-device-suggestion", "children"),
        Output("ai-user-suggestion", "children"),
        Output("ai-event-suggestion", "children"),
