    ...
    def generate_docker_compose(self) -> str:
        ...
        compose_config = {
            ...
            'services': {
                'yosai-dashboard': {
                    'build': '.',
                    'ports': ['80:8050'] if not self.config.ssl_enabled else ['443:8050'],
...
"""
    ...
    def health_check(self) -> Dict[str, Any]:
        ...
        checks = {
            ...
            'ssl_working': self._check_ssl_health() if self.config.ssl_enabled else True,
            'monitoring_active': self._check_monitoring_health() if self.config.monitoring_enabled else True
        }
